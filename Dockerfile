...
RUN pip install --upgrade pip && python -m pip install --upgrade setuptools==58.0.4 && \
    pip install opencv-python tb-nightly matplotlib logger_tt tabulate tqdm wheel mccabe scipy==1.7.1 pillow==8.3.1 imageio==2.9.0 nni==3.0 mmcv==1.7.1 scikit-image
