...
RUN pip install typing humanfriendly>=9.1 scipy timm h5py submitit scikit-image huggingface_hub safetensors tifffile>=2022.8.12 imageio>=2.27 networkx>=2.8 
...
RUN pip install triton==3.3.1 dill seaborn polars cython==0.29.33
